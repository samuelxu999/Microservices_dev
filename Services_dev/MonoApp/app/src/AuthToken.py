...
class AuthToken(object):
	...
	def initVTrustZone(self, str_VzoneID):
		...
		ret=self.contract.transact({'from': self.web3.eth.coinbase}).initVTrustZone(str_VzoneID)
...
if __name__ == "__main__":
	...
	contract_addr = AuthToken.getAddress('AuthToken', addr_list)
	contract_config = './contracts/AuthToken.json'
	...
	print("----------------------- read Vnode information -------------------------")
	node_address = AuthToken.getAddress('Desk_PI_Plus_Sam2', addr_list)
	...
	node_address = AuthToken.getAddress('Desk_PI_Plus_Sam1', addr_list)
