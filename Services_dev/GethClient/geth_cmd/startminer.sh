...
/opt/go-ethereum/build/bin/geth --identity "geth_node" --networkid 42 --datadir "/home/docker/account" --nodiscover --mine --minerthreads=1 --rpc --rpcport "8042" --port "30303" --ipcpath "/home/docker/.ethereum/geth.ipc"